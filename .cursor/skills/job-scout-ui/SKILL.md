...
Use `docs/design/job-scout-desktop.png` and `docs/design/job-scout-mobile.png` as visual references until JE-016 replaces them. Preserve the calm three-pane desktop layout and card-first mobile layout: cool off-white canvas, white surfaces, deep navy type, indigo primary, coral only for applied actions, restrained shadows, 14px radii.
